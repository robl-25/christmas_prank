...
import DotsCounter from '../components/DotsCounter.vue'
...
<template>
  ...
  <div class="text">
    <TextAnimated text='Neste nível você terá 2 minutos para acertar a resposta' v-if="showElements[1]"/>
    ...
    <TextAnimated text='Para pessoas com nome composto, é preciso digitar o nome composto' v-if="showElements[4]" />
